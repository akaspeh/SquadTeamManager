...
from modules.lineup.application.use_cases.remove_player_from_squad import (
    RemovePlayerFromSquad,
)
from modules.lineup.application.use_cases.add_squad_to_lineup import AddSquadToLineup
from modules.lineup.application.use_cases.remove_squad_from_lineup import (
    RemoveSquadFromLineup,
)
...
async def lineup_ws(websocket: WebSocket, lineup_id: str):
    ...
    try:
        while True:
            ...
            async with SqlAlchemyLineupUnitOfWork(
                data_base_manager.session_factory
            ) as uow:
                event = None
                # --- SQUAD ---
                if action == "add_squad":
                    ...
                    event = {
                        "type": "squad_added",
                        "data": {"squad_id": squad_id, "name": data["name"]},
                    }
                    ...
                    event = {"type": "squad_removed", "data": data}
                    ...
                    event = {"type": "player_removed", "data": data}
                    ...
                    event = {"type": "player_kit_changed", "data": data}
                    ...
                    event = {"type": "player_name_changed", "data": data}
